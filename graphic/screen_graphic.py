...
class ScreenDisplay:
    ...
    def displayHomeScreen(self):
        ...
        constants.SCREEN.blit(text, (800 / 2 - text.get_width()/2,
    ...
    def displayPlayAgain(self):
        ...
        self.text2 = self.font2.render(
            'Press Space Bar to play again or Escape to quit', 1, constants.WHITE)
        pygame.draw.rect(constants.SCREEN, constants.BLACK, (constants.LAST_GAME_PIXEL / 2 -
                                                             self.text2.get_width()/2, 500, self.text2.get_width(), self.text2.get_height()))
        constants.SCREEN.blit(
            self.text2, (constants.LAST_GAME_PIXEL / 2 - self.text2.get_width()/2, 500))